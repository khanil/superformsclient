...
export const SET_DATE_TO_DISPLAY = 'SET_DATE_TO_DISPLAY';
export const FETCH_TABLE_CSV_REQUEST = 'FETCH_TABLE_CSV_REQUEST';
export const FETCH_TABLE_CSV_SUCCESS = 'FETCH_TABLE_CSV_SUCCESS';
export const FETCH_TABLE_CSV_FAILURE = 'FETCH_TABLE_CSV_FAILURE';
